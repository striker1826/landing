...
const CompanyIntroBox = ({ number, text }: CompanyIntroBoxProps) => {
  return (
    <div
      className="w-full py-[28px] px-[32px] sm:py-[44px] sm:px-[48px] flex justify-between items-center gap-[28px] md:gap-[40px] lg:gap-[68px] rounded-[20px] border border-[1px] border-[#592FD4] bg-[#fff]"
