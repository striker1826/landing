    ...
    <div className="pb-[82px] flex flex-col items-center justify-center pt-[80px] bg-[url('/images/featureBenefit/bg.svg')] bg-cover bg-center bg-no-repeat">
      ...
      >
        <div className="mt-[40px] sm:mt-[112px] w-full flex flex-col sm:flex-row gap-[16px] items-center justify-center">
          <div className="relative w-[288px] h-[280px] sm:w-[396px] sm:h-[396px] sm:aspect-[396/384] md:w-[487px] md:h-[487px] md:aspect-[487/473] lg:w-[556px] lg:h-[540px] lg:aspect-[139/135]">
            <Image
          ...
          <div className="relative w-[288px] h-[324px] aspect-[36/35] sm:w-[396px] sm:h-[396px] sm:aspect-[396/384] md:w-[487px] md:h-[487px] md:aspect-[487/473] lg:w-[556px] lg:h-[540px] lg:aspect-[139/135]">
            <Image
